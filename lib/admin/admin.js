...
const pageInstances = [
  require('./route/admin.instance/admin.instance.json'),
  require('./route/admin.instance.property/admin.instance.property.json'),
  require('./route/admin.instance.create/admin.instance.create.json'),
  require('./route/admin.instance.create.property/admin.instance.create.property.json'),
  require('./route/admin.instance.create.type/admin.instance.create.type.json'),
  require('./route/admin.instance.create.id/admin.instance.create.id.json')
]
...
pageInstances.forEach(pageInstance => {
  ...
  try {
    ...
    console.log(`Registering controller for ${route}`)
  } catch (e) {
    controllers[route] = {}
    console.log(`Failed to register controller for ${route}`)
  }
})
