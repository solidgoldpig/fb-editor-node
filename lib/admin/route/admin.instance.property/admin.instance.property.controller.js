...
instancePropertyController.setData = (pageInstance, pageData, POST) => {
  ...
  let value = createMode ? pageData.getUserDataProperty('value') : getSourceInstanceProperty(_id, property, discreteInstance.$source)

  let inheritedValue = createMode ? runtimeInstance[property] : getInstanceProperty(_id, property)
