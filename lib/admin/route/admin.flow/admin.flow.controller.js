        ...
        if (flowDraft.steps) {
          ...
          flowDraft.flowsteps.forEach((draftStep, index, arr) => {
            if (draftStep.show && typeof draftStep.show === 'object') {
              ...
              const draftStepSourceInstance = getSourceInstance(draftStep._id)
              const nextStepSourceInstance = nextStep ? getSourceInstance(nextStep._id) : undefined
              const previousStepSourceInstance = previousStep ? getSourceInstance(previousStep._id) : undefined
